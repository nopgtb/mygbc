...
#include "components/instruction_set_lr35902/instruction_decoder_lr35902.h" //InstructionDecoderLR35902
    ...
    if(argc > 1){
            ...
            if(buffer.ok()){ // No error
                ...
                if(gbc_binary.ok()){
                    ...
                    InstructionSetLR35902 lr35902_instructions;
                    const uint16_t cartridge_entry_point = 0x100;
                    StatusOr<InstructionLR35902> instruction = InstructionDecoderLR35902::decode(gbc_binary.value(), cartridge_entry_point, lr35902_instructions);
                    if(instruction.ok()){
