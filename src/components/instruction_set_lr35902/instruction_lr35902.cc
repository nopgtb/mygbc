...
read_value_size_in_bytes(0), read_value_operand_position(0), read_value_operand_interp_hint(InstructionLR35902::OperandValueInterpHint::NONE),
...
read_value_size_in_bytes(r_val_size), read_value_operand_position(r_val_pos), read_value_operand_interp_hint(r_val_interp_hint),
